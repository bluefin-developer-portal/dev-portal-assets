...
public class CRC
{
    ...
    public static class Parameters
    {
        ...
        /** CRC-A parameters */
        public static final Parameters CRCA = new Parameters(16, 0x1021, 0xC6C6, true, true, 0x0000);;
    ...
    public static byte[] swapCrcBytes(long in){
        String s = Long.toHexString(in);
        if(s != null && s.length() % 2 != 0){
            s = "0" + s;
        }
        byte[] crcTmp = ByteUtil.hexStr2Bytes(s);
        return new byte[]{crcTmp[1], crcTmp[0]};
    }
